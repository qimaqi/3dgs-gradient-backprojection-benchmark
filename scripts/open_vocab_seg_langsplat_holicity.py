...
def main():
    ...
    argparser.add_argument("--val_split_path", type=str, default="/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/3dgs-gradient-backprojection-benchmark/splits/holicity_mini_val.txt")
    argparser.add_argument("--preprocessed_root", type=str, default="/srv/beegfs02/scratch/qimaqi_data/data/holicity_val_set_preprocessed")
    argparser.add_argument("--gs_root", type=str, default="/srv/beegfs02/scratch/qimaqi_data/data/holicity_val_set_suite/mcmc_3dgs")
    ...
    langfeat_root = "/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/3dgs-gradient-backprojection-benchmark/results/holicity"
    ...
    "this is a pedestrian"]    # we map this to "terrain" when evaluating
    ...
    with torch.no_grad():
        text_tokens = clip.tokenize(holicity_label_prompt)
    ...
    benchmarks = [
        {
            ...
            'confusion_mat': np.zeros((len(Holicity_LABELS), len(Holicity_LABELS)), dtype=np.int64),
    ...
    for scene_id in tqdm(scene_ids, desc="Processing scenes"):
        ...
        xyz_path = os.path.join(langfeat_root, scene_id, "xyz_lseg_512_512.npy")
        langfeat_path = os.path.join(langfeat_root, scene_id, "features_lseg_512_512.pt")
        ...
        for bench in benchmarks:
            ...
            save_fname = f"holicity_backproject_lseg_{scene_id}_semseg_pred.npy"
            ...
            colorized_pred = Holicty_COLORS[top1_preds_all]
            ...
            save_vis_path = os.path.join(langfeat_root, scene_id, f"holicity_backproject_lseg_{scene_id}_semseg_pred.ply")

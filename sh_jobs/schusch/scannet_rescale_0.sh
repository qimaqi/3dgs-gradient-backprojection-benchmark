#!/bin/bash
#SBATCH --job-name=scannet_rescale_0
#SBATCH --output=sbatch_log/scannet_rescale_0_%j.out
#SBATCH --nodes=1
...
python run_scannet.py --rescale 0 --split /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/3dgs-gradient-backprojection-benchmark/splits/scannet_mini_val.txt --start_idx 0 --end_idx 5

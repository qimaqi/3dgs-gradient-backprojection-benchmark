#!/bin/bash
#SBATCH --job-name=scannetpp_rescale_0
#SBATCH --output=sbatch_log/scannetpp_rescale_0_%j.out
#SBATCH --nodes=1
...
python run_scannetpp.py --rescale 0 --split /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/3dgs-gradient-backprojection-benchmark/splits/scannetpp_mini_val.txt

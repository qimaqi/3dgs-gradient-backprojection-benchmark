#!/bin/bash
#SBATCH --job-name=matterport_rescale_0
#SBATCH --output=sbatch_log/matterport_rescale_0_%j.out
#SBATCH --nodes=1
...
python run_matterport.py --rescale 0 --split /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/3dgs-gradient-backprojection-benchmark/splits/matterport3d_test.txt
